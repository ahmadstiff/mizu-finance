...
function CarouselCustomNavigation() {
  ...
  return (
    ...
    >
      <Carousel setApi={setApi} className="rounded-3xl overflow-hidden mx-5">
        <CarouselContent>
        ...
        <CarouselPrevious
          ...
          className="left-2 bg-white/30 hover:bg-white/50"
        />
        <CarouselNext
          onClick={(e) => {
            e.stopPropagation();
          ...
          className="right-2 bg-white/30 hover:bg-white/50"
        />
      </Carousel>
